...
const CssVariablesTab: React.FC = () => {
  ...
  return (
    <SettingSection id="general" heading="CSS variables">
      <Table striped>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              The font size of data on the top line above the title on cards and
              card modals.
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              The background color for cards and card modals with no associated
              file.
            </td>
            <td>
              <code>#26333d</code>
          ...
          <tr>
            ...
            <td>
              The maximum width of card modals at browser window sizes of 992px
              or larger.
            </td>
            <td>
              <code>640px</code>
          ...
          <tr>
            ...
            <td>
              The font and background color used in various places to denote an
              intersex performer.
            </td>
            <td>
              <code>#c8a2c8</code>
